defmodule PeerLearningWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PeerLearningWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PeerLearningWeb.Gettext, "errors", msg, opts)
    end
  end
